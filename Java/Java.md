...
- Usa-se um operador unário de conversão, que consiste em colocar o identificador do tipo de destino entre parênteses antes da expressão a ser convertida. Nesse caso, o programador deve estar ciente de que pode perder precisão, conforme o
tipo de coerção.
